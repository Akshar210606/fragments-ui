...
const cognitoAuthConfig = {
    authority: `https://cognito-idp.us-east-1.amazonaws.com/${"us-east-1_oV4F5M5t2"}`,
    client_id: "7tugjqis2m9jqalm2gmmkgjrr1",
...
async function getUserFragments(user) {
    ...
    try {
        ...
        if (!res.ok) // Non-2xx response: throw so we hit the catch block
